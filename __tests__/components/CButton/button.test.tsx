...
describe('CButton', () => {
    test('should be defined', () => {
        ...
        const { getByRole, getByLabelText } = render(<CButton label="Submit" isDisabled={buttonState} />)
    ...
    test('should have the disabled attribute', () => {
        let buttonState = false
        const { getByLabelText } = render(<CButton label="Submit" isDisabled={buttonState} />)
